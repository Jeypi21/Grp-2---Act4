...
void initializeSeats(struct plane seats[ROWS][COLUMNS]);

void displaySeats(struct plane seats[ROWS][COLUMNS]);

int allSeatsAssigned(struct plane seats[ROWS][COLUMNS]);

int main() {
    struct plane seats[ROWS][COLUMNS];
    char input[4], letter;
