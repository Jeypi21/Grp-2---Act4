...
int main() {
    ...
    do {
        ...
        do {
            ...
            scanf(" %c", &menuAgain);
            getchar();
        } while (!(menuAgain == 'y' || menuAgain == 'Y' || menuAgain == 'n' || menuAgain == 'N'));
...
void inputAndBill(struct billing bills[], int *billCount) {
    ...
    do {
        ...
        do {
            ...
            if (!(confirmPWD == 'y' || confirmPWD == 'Y' || confirmPWD == 'n' || confirmPWD == 'N')) {
                printf("---Invalid Input---\n");
            }
        } while (!(confirmPWD == 'y' || confirmPWD == 'Y' || confirmPWD == 'n' || confirmPWD == 'N'));
        ...
        do {
            ...
            if (!(confirmSenior == 'y' || confirmSenior == 'Y' || confirmSenior == 'n' || confirmSenior == 'N')) {
                printf("---Invalid Input---\n");
            }
        } while (!(confirmSenior == 'y' || confirmSenior == 'Y' || confirmSenior == 'n' || confirmSenior == 'N'));
...
void getDate(struct date *date) {
    ...
    scanf("%s %d %d", date->month, &date->day, &date->year);
    getchar();
}
...
void addMenu(struct menuItem *menu){
    ...
    for(int i = 0; i < add; i++){
        do {
            ...
            if (strcmp(menu[menuSize].code,menu[i].code) == 0){
...
void generateTotalSale(struct billing *bills, int billCount){
    ...
    printf("\nAs of %s %d %d\n", bills->date.month, bills->date.day, bills->date.year);
